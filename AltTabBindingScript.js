...
var SUBMAP = "bitr0t-omarchy-mission-control-alt-tab"
var SHELL_TARGET = "bitr0t.omarchy-mission-control"
...
function generateApply(raw) {
  ...
  return [
    ...
    "  return _G.bitr0t_omarchy_mission_control_alt_tab_owner == owner",
    "end",
    "local function live()",
    "  return owned() and _G.bitr0t_omarchy_mission_control_alt_tab_active == true",
    "end",
    ...
    "local previous = _G.bitr0t_omarchy_mission_control_alt_tab_binds",
    "if type(previous) == \"table\" then",
    "  for index = 1, #previous do",
    "    disable(previous[index])",
    "  end",
    "end",
    "_G.bitr0t_omarchy_mission_control_alt_tab_binds = {}",
    "local binds = _G.bitr0t_omarchy_mission_control_alt_tab_binds",
    "_G.bitr0t_omarchy_mission_control_alt_tab_owner = owner",
    "_G.bitr0t_omarchy_mission_control_alt_tab_active = false",
    "local function stop()",
    "  pending_delta = 0",
    ...
    "  local was_active = _G.bitr0t_omarchy_mission_control_alt_tab_active == true",
    ...
    "  pending_delta = 0",
    "  poll_ticks = 0",
    "  _G.bitr0t_omarchy_mission_control_alt_tab_active = true",
...
function generateCleanup(raw) {
  ...
  return [
    ...
    "  end",
    "end",
    "_G.bitr0t_omarchy_mission_control_alt_tab_binds = nil",
    "if _G.bitr0t_omarchy_mission_control_alt_tab_owner == owner then",
    "  _G.bitr0t_omarchy_mission_control_alt_tab_owner = nil",
    "  _G.bitr0t_omarchy_mission_control_alt_tab_active = false",
    "  hl.unbind(\"ALT + TAB\")",
    "  hl.unbind(\"ALT + SHIFT + TAB\")",
    "end"
